...
(defun yujo-chinese/init-fcitx ()
  (use-package fcitx
    :init
    (fcitx-evil-turn-on)))

(defun yujo-chinese/init-chinese-wbim ()
...
(defun yujo-chinese/init-youdao-dictionary ()
...
(defun yujo-chinese/init-find-by-pinyin-dired ()
  (use-package find-by-pinyin-dired
    :defer t))

(defun yujo-chinese/init-ace-pinyin ()
...
(defun yujo-chinese/init-pangu-spacing ()
...
(defun yujo-chinese/post-init-org ()
